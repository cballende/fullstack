  ...
  function () {
    ...
    function e(t) {
      if (!j) {
        ...
        e.href = x.location.href,
        j.head.appendChild(e)
      }
      return j.body.innerHTML = t,
      j.body.childNodes
    }
    function i(t) {
    ...
    function n(n, s) {
      ...
      this;
      if (!o) return this;
      if (o.nodeType || o === T) this[0] = o,
      this.length = 1;
       else for (r = this.length = o.length; r > a; a++) this[a] = o[a];
      return this
    }
    function s(t, e) {
      return new n(t, e)
    ...
    function f(t, e, i) {
      t.classList ? t.classList.add(e) : i.indexOf(' ' + e + ' ') &&
      (t.className += ' ' + e)
    }
    function m(t, e) {
    ...
    function g(t, e) {
      return parseInt(T.getComputedStyle(t[0], null) [e], 10) ||
      0
    }
    function y(t, e, i) {
    ...
    W = /^\w+$/,
    j,
    F = s.fn = s.prototype = n.prototype = {
      cash: !0,
      length: 0,
      push: D,
      splice: O.splice,
    ...
    s.extend = F.extend = function (t) {
      ...
      i = e.length,
      n = 1;
      for (1 === e.length && (t = this, n = 0); i > n; n++) if (e[n]) for (var s in e[n]) e[n].hasOwnProperty(s) &&
      (t[s] = e[n][s]);
      return t
    },
    s.extend({
    ...
    o(
      ...
      function (t) {
        ...
        F['outer' + t] = function (e) {
          return this[0]['offset' + t] + (
            e ? g(this, 'margin' + ('Width' === t ? 'Left' : 'Top')) + g(this, 'margin' + ('Width' === t ? 'Right' : 'Bottom')) : 0
          )
        }
      }
    ),
    ...
    F.extend({
      ...
      closest: function (t) {
        return !t ||
        this.length < 1 ? s() : this.is(t) ? this.filter(t) : this.parent().closest(t)
      },
      is: function (t) {
        if (!t) return !1;
        var e = !1,
      ...
      parents: function (t) {
        ...
        return this.each(
          function (n) {
            for (e = n; e && e.parentNode && e !== x.body.parentNode; ) e = e.parentNode,
            (!t || t && a(e, t)) &&
            i.push(e)
          }
        ),
...
M.initializeJqueryWrapper = function (t, e, i) {
  jQuery.fn[e] = function (n) {
    ...
    n ? void jQuery.error('Method ' + n + ' does not exist on jQuery.' + e) : (t.init(this, arguments[0]), this)
  }
},
...
M.getOverflowParent = function (t) {
  return null == t ? null : t === document.body ||
  'visible' !== getComputedStyle(t).overflow ? t : M.getOverflowParent(t.parentElement)
},
M.getIdFromTrigger = function (t) {
  var e = t.getAttribute('data-target');
  return e ||
  (e = t.getAttribute('href'), e = e ? e.slice(1) : ''),
  e
},
...
M.throttle = function (t, e, i) {
  ...
  return function () {
    ...
    return n = this,
    s = arguments,
    0 >= d ? (clearTimeout(a), a = null, r = h, o = t.apply(n, s), n = s = null) : a ||
    i.trailing === !1 ||
    (a = setTimeout(l, d)),
    o
  }
...
$jscomp.getGlobal = function (t) {
  ...
  window === t ? t : 'undefined' != typeof global &&
  null != global ? global : t
},
  ...
  function () {
    ...
    function n(e) {
      return P.arr(e) ? e : (
        ...
        e instanceof HTMLCollection ? [].slice.call(e) : [
          e
        ]
      )
    }
    ...
    function d(t) {
      return (
        t = /([\+\-]?[0-9#\.]+)(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(t)
      ) ? t[2] : void 0
    }
    function u(t) {
      return - 1 < t.indexOf('translate') ||
      'perspective' === t ? 'px' : - 1 < t.indexOf('rotate') ||
      - 1 < t.indexOf('skew') ? 'deg' : void 0
    }
    function c(t, e) {
      return P.fnc(t) ? t(e.target, e.id, e.total) : t
    }
    function p(t, e) {
      return e in t.style ? getComputedStyle(t).getPropertyValue(e.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase()) ||
      '0' : void 0
    }
    function v(t, e) {
      return P.dom(t) &&
      s(R, e) ? 'transform' : P.dom(t) &&
      (t.getAttribute(e) || P.svg(t) && t[e]) ? 'attribute' : P.dom(t) &&
      'transform' !== e &&
      p(t, e) ? 'css' : null != t[e] ? 'object' : void 0
    }
    function f(t, i) {
      var n = u(i),
    ...
    function k(t, e) {
      function i(i) {
        ...
        t.el.getPointAtLength(e + i >= 1 ? e + i : 0)
      }
      var n = i(),
      s = i( - 1),
      o = i(1);
    ...
    function C(t, e) {
      ...
      if (n = P.pth(t) ? t.totalLength : t, P.col(n)) if (P.rgb(n)) {
       ...
       else s = (s = d(n)) ? n.substr(0, n.length - s.length) : n,
      n = e &&
      !/\s/g.test(n) ? s + e : s;
      return n += '',
      {
        original: n,
        numbers: n.match(i) ? n.match(i).map(Number) : [
          0
        ],
        strings: P.str(t) ||
        e ? n.split(i) : []
    ...
    function w(t) {
      return t = t ? i(P.arr(t) ? t.map(n) : n(t)) : [],
      e(t, function (t, e, i) {
        return i.indexOf(t) === e
      })
    }
    ...
    function M(t, e) {
      ...
      if (P.arr(t)) {
        var s = t.length;
        2 !== s ||
        P.obj(t[0]) ? P.fnc(e.duration) ||
        (i.duration = e.duration / s) : t = {
          value: t
        }
      }
      return n(t).map(
    ...
    function S(t) {
      ...
      function s(t) {
        for (var i = 0, n = {}, s = v.animations, o = s.length; o > i; ) {
          ...
          for (
            ...
            u = isNaN(l) ? 1 : d.easing(l, d.elasticity),
            l = d.to.strings,
            c = d.round,
            h = [],
            f = void 0,
            ...
            c &&
            (d.isColor && m > 2 || (g = Math.round(g * c) / c)),
            h.push(g)
          }
          if (d = l.length) for (f = l[0], u = 0; d > u; u++) c = l[u + 1],
          m = h[u],
          isNaN(m) ||
          (f = c ? f + (m + c) : f + (m + ' '));
           else f = h[0];
          F[a.type](r.target, a.property, f, n, r.id),
          a.currentValue = f,
          i++
        }
        if (i = Object.keys(n).length) for (s = 0; i > s; s++) H ||
        (
          H = p(document.body, 'transform') ? 'transform' : '-webkit-transform'
        ),
        v.animatables[s].target.style[H] = n[s].join(' ');
        v.currentTime = t,
      ...
      function r(t) {
        ...
        g > r &&
        e > g ? s(g) : (r >= g && 0 !== f && (s(0), m && a()), (g >= e && f !== e || !e) && (s(e), m || a())),
        o('update'),
        t >= e &&
        (
          v.remaining ? (h = l, 'alternate' === v.direction && (v.reversed = !v.reversed)) : (
            v.pause(),
            v.completed ||
      ...
      v.play = function () {
        v.paused &&
        (v.paused = !1, h = 0, d = n(v.currentTime), q.push(v), N || z())
      },
      v.reverse = function () {
    ...
    j = function () {
      function t(t, e) {
        return 0 === t ||
        1 === t ? t : - Math.pow(2, 10 * (t - 1)) * Math.sin(2 * (t - 1 - e / (2 * Math.PI) * Math.asin(1)) * Math.PI / e)
      }
    ...
    S.remove = function (t) {
      t = w(t);
      for (var e = q.length; e--; ) for (var i = q[e], n = i.animations, o = n.length; o--; ) s(t, n[o].animatable.target) &&
...
function ($, t) {
  ...
  i = function (i) {
    function n(t, e) {
      ...
      i.focusedIndex = - 1,
      i.filterQuery = [],
      i.options.container ? $(i.options.container).append(i.dropdownEl) : i.$el.after(i.dropdownEl),
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          ...
          value: function v(t) {
            var e = $(t.target);
            e.closest('.dropdown-content').length &&
        ...
        },
        {
          ...
          value: function m(t) {
            ...
            if (a && - 1 === r.indexOf(t.which)) {
              ...
              h &&
              (this.focusedIndex = $(h).index(), this._focusFocusedItem())
            }
          ...
          value: function k() {
            ...
            if (
              ...
              (
                h.bottom ? d = 'bottom' : (
                  this.isScrollable = !0,
                  h.spaceOnTop > h.spaceOnBottom ? (d = 'bottom', n += h.spaceOnTop, a -= h.spaceOnTop) : n += h.spaceOnBottom
                )
              ),
              !h[u]
            ) {
            ...
            return 'bottom' === d &&
            (a = a - i.height + (this.options.coverTrigger ? e.height : 0)),
            'right' === u &&
            (o = o - i.width + e.width),
            {
              x: o,
...
function ($, t) {
  ...
  i = function (i) {
    function n(t, e) {
      ...
      i.$overlay = $('<div class="modal-overlay"></div>'),
      i.el.tabIndex = 0,
      i._nthModalOpened = 0,
      n._count++,
      i._setupEventHandlers(),
        ...
        },
        {
          ...
          value: function c() {
            ...
            var i = {
              ...
              complete: function () {
                'function' == typeof e.options.onOpenEnd &&
                e.options.onOpenEnd.call(e, e.el, e._openingTrigger)
              }
            };
...
function ($, t) {
  ...
  i = function (i) {
    function n(t, e) {
      ...
      i.overlayActive = !1,
      i.doneAnimating = !0,
      i.placeholder = $('<div></div>').addClass('material-placeholder'),
      i.originalWidth = 0,
      i.originalHeight = 0,
      ...
      [
        ...
        },
        {
          ...
          value: function r(t) {
            ...
            this.overlayActive &&
            this.doneAnimating ? this.close() : this.open()
          }
        },
        {
          ...
          value: function p() {
            ...
            i = {
              ...
              complete: function () {
                ...
                e.attrWidth &&
                e.$el.attr('width', e.attrWidth),
                e.attrHeight &&
                e.$el.attr('height', e.attrHeight),
        ...
        },
        {
          ...
          value: function f() {
            ...
            this.newHeight = 0,
            s > o ? (
              n = this.originalHeight / this.originalWidth,
              this.newWidth = 0.9 * this.windowWidth,
              this.newHeight = 0.9 * this.windowWidth * n
            ) : (
              n = this.originalWidth / this.originalHeight,
              this.newWidth = 0.9 * this.windowHeight * n,
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.el.M_Parallax = n,
      n.options = $.extend({
      }, i.defaults, e),
      n._enabled = window.innerWidth > n.options.responsiveThreshold,
      n.$img = n.$el.find('img').first(),
      n.$img.each(function () {
        var t = this;
        t.complete &&
        $(t).trigger('load')
      ...
      [
        ...
        },
        {
          ...
          value: function s() {
            ...
            (
              i._handleScrollThrottled = M.throttle(i._handleScroll, 5),
        ...
        },
        {
          ...
          value: function l() {
            ...
            this._enabled ? n > o &&
            o + a > s &&
            (this.$img[0].style.transform = 'translate3D(-50%, ' + h + 'px, 0)') : this.$img[0].style.transform = ''
          }
        }
      ],
      [
  ...
  M.Parallax = e,
  M.jQueryLoaded &&
  M.initializeJqueryWrapper(e, 'parallax', 'M_Parallax')
}(cash),
function ($, t) {
  'use strict';
  var e = {
    ...
    _createClass(
      ...
      [
          ...
          value: function l(t) {
            ...
            if (n.length && n.parent().hasClass('tab')) {
              ...
              if (!n.attr('target')) {
                ...
                this.$content = $(M.escapeHash(n[0].hash)),
        ...
        },
        {
          ...
          value: function p() {
            this.$tabLinks.not(this.$activeTabLink).each(
              function (t) {
                if (t.hash) {
  ...
  window.M.Tabs = i,
  M.jQueryLoaded &&
  M.initializeJqueryWrapper(i, 'tabs', 'M_Tabs')
}(cash, M.anime),
function ($, t) {
  'use strict';
  var e = {
      ...
      [
        ...
        },
        {
          ...
          value: function p() {
            ...
            this.xMovement = 0,
            this.yMovement = 0,
            l = t.getBoundingClientRect().top + M.getDocumentScrollTop(),
            h = t.getBoundingClientRect().left + M.getDocumentScrollLeft(),
            ...
            a = this._repositionWithinScreen(h, l, o, s),
            $(e).css({
              top: a.y + 'px',
              left: a.x + 'px'
            })
...
function (t) {
  ...
  h = {
    ...
    show: function (t, e) {
      ...
      'touches' in t &&
      (r = t.touches[0].pageY - a.top, l = t.touches[0].pageX - a.left),
  ...
  d = {
    ...
    allowEvent: function (t) {
      var e = !0;
      return 'touchstart' === t.type ? d.touches += 1 : 'touchend' === t.type ||
      'touchcancel' === t.type ? setTimeout(function () {
        d.touches > 0 &&
        (d.touches -= 1)
      }, 500) : 'mousedown' === t.type &&
      d.touches > 0 &&
      (e = !1),
      e
    },
      ...
      [
        {
          ...
          value: function n() {
            ...
            $(t).addClass(this.options.classes),
            (
              'object' == typeof HTMLElement ? this.message instanceof HTMLElement : this.message &&
              'object' == typeof this.message &&
              null !== this.message &&
              1 === this.message.nodeType &&
              'string' == typeof this.message.nodeName
            ) ? t.appendChild(this.message) : this.message.jquery ? $(t).append(this.message[0]) : t.innerHTML = this.message,
      ...
      [
        ...
        },
        {
          ...
          value: function p(t) {
            ...
            t.targetTouches.length >= 1 ? t.targetTouches[0].clientX : t.clientX
          }
        },
        {
          key: 'dismissAll',
      ...
      [
        ...
        },
        {
          ...
          value: function x() {
            ...
            this.isDragged &&
            0 == this.percentOpen ? this._overlay.style.display = 'none' : this._animateOut()
          }
        },
        {
          key: '_animateIn',
        ...
        },
        {
          ...
          value: function O() {
            ...
            this.isDragged &&
            (
              i = 'left' === this.options.edge ? i + this.percentOpen : i - this.percentOpen
            ),
            t.remove(this.el),
            t({
              targets: this.el,
        ...
        },
        {
          ...
          value: function D() {
            ...
            this.isDragged &&
            (
              n = 'left' === this.options.edge ? i + this.percentOpen : i - this.percentOpen
            ),
            t.remove(this.el),
            t({
              targets: this.el,
      ...
      [
        ...
        },
        {
          ...
          value: function h() {
            ...
            n._visibleElements[0] ? (
              $(
                this.options.getActiveElement(n._visibleElements[0].attr('id'))
              ).removeClass(this.options.activeClass),
              n._visibleElements[0][0].M_ScrollSpy &&
              this.id < n._visibleElements[0][0].M_ScrollSpy.id ? n._visibleElements.unshift(this.$el) : n._visibleElements.push(this.$el)
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      n.activeIndex = - 1,
      n.oldVal,
      n.$inputField = n.$el.closest('.input-field'),
      n.$active = $(),
      n._mousedown = !1,
      n._setupDropdown(),
      n._setupEventHandlers(),
      ...
      [
        ...
        },
        {
          ...
          value: function d(t) {
            ...
            return e === M.keys.ENTER &&
            this.activeIndex >= 0 ? (
              n = $(this.container).children('li').eq(this.activeIndex),
              void (n.length && (this.selectOption(n), t.preventDefault()))
            ) : void (
        ...
        },
        {
          ...
          value: function y(t, e) {
            ...
            for (var r = 0; r < n.length; r++) {
              ...
              h = $('<li></li>');
              l.data ? h.append(
                '<img src="' + l.data + '" class="right circle"><span>' + l.key + '</span>'
...
function ($) {
  M.updateTextFields = function () {
    ...
    $(t).each(
      function (t, e) {
        ...
        $(t).is(':focus') ||
        t.autofocus ||
        null !== i.attr('placeholder') ? i.siblings('label').addClass('active') : t.validity ? i.siblings('label').toggleClass('active', t.validity.badInput === !0) : i.siblings('label').removeClass('active')
      }
    )
  },
  M.validate_field = function (t) {
    ...
    n = t[0].value.length;
    0 !== n ||
    t[0].validity.badInput !== !1 ||
    t.is(':required') ? t.hasClass('validate') &&
    (
      t.is(':valid') &&
      e &&
      i >= n ||
      t.is(':valid') &&
      !e ? (t.removeClass('invalid'), t.addClass('valid')) : (t.removeClass('valid'), t.addClass('invalid'))
    ) : t.hasClass('validate') &&
  ...
  M.textareaAutoResize = function (t) {
    ...
    e.length ||
    (
      e = $('<div class="hiddendiv common"></div>'),
      $('body').append(e)
    );
    ...
    e.css('padding-top', o),
    a &&
    e.css('padding-right', a),
    r &&
    e.css('padding-bottom', r),
    l &&
    ...
    e.html(h),
    t[0].offsetWidth > 0 &&
    t[0].offsetHeight > 0 ? e.css('width', t.width() + 'px') : e.css('width', window.innerWidth / 2 + 'px'),
    t.data('original-height') <= e.innerHeight() ? t.css('height', e.innerHeight() + 'px') : t[0].value.length < t.data('previous-length') &&
  ...
  $(document).ready(
    function () {
      ...
      $(document).on(
        ...
        function () {
          for (
            var t = $(this).closest('.file-field'),
            e = t.find('input.file-path'),
            i = $(this) [0].files,
            n = [],
            s = 0;
            s < i.length;
...
function ($, t) {
  ...
  i = function (i) {
    function n(e, i) {
      ...
      s._setupIndicators(),
      s.$active ? s.$active.css('display', 'block') : (
      ...
      [
        ...
        },
        {
          ...
          value: function h(e, i) {
            ...
            $(e).hasClass('center-align') ? n.translateY = - 100 : $(e).hasClass('right-align') ? n.translateX = 100 : $(e).hasClass('left-align') &&
            (n.translateX = - 100),
            t(n)
          }
        },
  ...
  $(document).on(
    ...
    function (e) {
      if ($(this).children('.card-reveal').length) {
        ...
        $(e.target).is($('.card-reveal .card-title i')) ? t({
          targets: n[0],
          translateY: 0,
          duration: 225,
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.el.M_Chips = n,
      n.options = $.extend({
      }, i.defaults, e),
      n.$el.addClass('chips input-field'),
      n.chipsData = [],
      n.$chips = $(),
      n._setupInput(),
      n.hasAutocomplete = Object.keys(n.options.autocompleteOptions).length > 0,
      n.$input.attr('id') ||
      n.$input.attr('id', M.guid()),
      n.options.data.length &&
      (n.chipsData = n.options.data, n._renderChips(n.chipsData)),
      n.hasAutocomplete &&
      n._setupAutocomplete(),
      n._setPlaceholder(),
      n._setupLabel(),
      n._setupEventHandlers(),
      n
      ...
      [
          ...
          value: function u(t) {
            if (t.tag) {
              ...
              if (
                ...
                $(i).addClass('material-icons close'),
                i.textContent = 'close',
                t.image
              ) {
        ...
        },
        {
          ...
          value: function m() {
            ...
            !this.chipsData.length &&
            this.options.placeholder ? $(this.$input).prop('placeholder', this.options.placeholder) : (void 0 === this.chipsData || this.chipsData.length) &&
  ...
  M.Chips = e,
  M.jQueryLoaded &&
  M.initializeJqueryWrapper(e, 'chips', 'M_Chips'),
  $(document).ready(
    function () {
      $(document.body).on(
        'click',
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.el.M_Pushpin = n,
      n.options = $.extend({
      }, i.defaults, e),
      n.originalOffset = n.el.offsetTop,
      i._pushpins.push(n),
      n._setupEventHandlers(),
      n._updatePosition(),
      n
  ...
  M.Pushpin = e,
  M.jQueryLoaded &&
  M.initializeJqueryWrapper(e, 'pushpin', 'M_Pushpin')
}(cash),
function ($, t) {
  'use strict';
  var e = {
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          key: '_handleDocumentClick',
          value: function l(t) {
            $(t.target).closest(this.$menu).length ||
            this.close()
          }
        },
        {
  ...
  M.jQueryLoaded &&
  M.initializeJqueryWrapper(i, 'floatingActionButton', 'M_FloatingActionButton')
}(cash, M.anime),
function ($) {
  'use strict';
  var t = {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      (n.options.i18n = $.extend({
      }, i.defaults.i18n, e.i18n)),
      n.options.minDate &&
      n.options.minDate.setHours(0, 0, 0, 0),
      n.options.maxDate &&
      n.options.maxDate.setHours(0, 0, 0, 0),
      n.id = M.guid(),
      n._setupVariables(),
      n._insertHTMLIntoDOM(),
      n._setupModal(),
      n._setupEventHandlers(),
      n.options.defaultDate ||
      (n.options.defaultDate = new Date(Date.parse(n.el.value)));
      var s = n.options.defaultDate;
      return i._isDate(s) ? n.options.setDefaultDate ? (n.setDate(s, !0), n.setInputValue()) : n.gotoDate(s) : n.gotoDate(new Date),
      n.isOpen = !1,
      n
    }
    return _inherits(i, e),
      ...
      [
        ...
        },
        {
          ...
          value: function s() {
            ...
            t &&
            M.FormSelect.getInstance(t).destroy();
            var e = this.calendarEl.querySelector('.orig-select-month');
            e &&
            M.FormSelect.getInstance(e).destroy()
          }
        },
        {
        ...
        },
        {
          ...
          value: function m(t, e, n) {
            ...
            s.firstDay > 0 &&
            (r -= s.firstDay, 0 > r && (r += 7));
            for (
              var d = 0 === e ? 11 : e - 1,
              u = 11 === e ? 0 : e + 1,
              c = 0 === e ? t - 1 : t,
              p = 11 === e ? t + 1 : t,
              v = i._getDaysInMonth(c, d),
              f = a + r,
              m = f;
              m > 7;
            ) m -= 7;
            ...
            for (var g = !1, y = 0, _ = 0; f > y; y++) {
              ...
              T = t,
              O = s.startRange &&
              i._compareDates(s.startRange, b),
              L = s.endRange &&
              i._compareDates(s.endRange, b),
              B = s.startRange &&
              s.endRange &&
              s.startRange < b &&
              b < s.endRange,
              ...
              7 === ++_ &&
              (l.push(this.renderRow(h, s.isRTL, g)), h = [], _ = 0, g = !1)
            }
        ...
        },
        {
          ...
          value: function g(t) {
            ...
            t.isEndRange &&
            e.push('is-endrange'),
            '<td data-day="' + t.day + '" class="' + e.join(' ') + '" aria-selected="' + i + '">' + (
              '<button class="datepicker-day-button" type="button" data-year="' + t.year + '" data-month="' + t.month + '" data-day="' + t.day + '">' + t.day + '</button>'
            ) + '</td>'
          }
        },
        {
        ...
        },
        {
          ...
          value: function b(t) {
            var e = void 0,
            i = [];
            for (e = 0; 7 > e; e++) i.push(
              '<th scope="col"><abbr title="' + this.renderDayName(t, e) + '">' + this.renderDayName(t, e, !0) + '</abbr></th>'
            );
        ...
        },
        {
          ...
          value: function C(t, e, i, n, s, o) {
            ...
            f = !0,
            m = !0;
            for (l = [], a = 0; 12 > a; a++) l.push(
              '<option value="' + (i === s ? a - e : 12 + a - e) + '"' + (a === n ? ' selected="selected"' : '') + (d && a < h.minMonth || u && a > h.maxMonth ? 'disabled="disabled"' : '') + '>' + h.i18n.months[a] + '</option>'
            );
            for (
              p = '<select class="datepicker-select orig-select-month" tabindex="-1">' + l.join('') + '</select>',
              $.isArray(h.yearRange) ? (a = h.yearRange[0], r = h.yearRange[1] + 1) : (a = i - h.yearRange, r = 1 + i + h.yearRange),
              l = [];
              r > a &&
              a <= h.maxYear;
              a++
            ...
            l.push(
              '<option value="' + a + '" ' + (a === i ? 'selected="selected"' : '') + '>' + a + '</option>'
            );
            ...
            c += '<button class="month-prev' + (f ? '' : ' is-disabled') + '" type="button">' + g + '</button>',
            c += '<div class="selects-container">',
            c += h.showMonthAfterYear ? v + p : p + v,
            c += '</div>',
            d &&
            (0 === n || h.minMonth >= n) &&
            (f = !1),
            ...
            return c += '<button class="month-next' + (m ? '' : ' is-disabled') + '" type="button">' + y + '</button>',
            c += '</div>'
          }
        },
        {
          ...
          value: function w(t) {
            if (this.isOpen || t) {
              ...
              r = void 0;
              this._y <= i &&
              (this._y = i, !isNaN(s) && this._m < s && (this._m = s)),
              this._y >= n &&
              (this._y = n, !isNaN(o) && this._m > o && (this._m = o)),
              r = 'datepicker-title-' + Math.random().toString(36).replace(/[^a-z]+/g, '').substr(0, 2);
              for (var l = 0; 1 > l; l++) this._renderDateDisplay(),
              a += this.renderTitle(
                this,
                l,
          ...
          value: function B(t) {
            if (this.isOpen) {
              ...
              (
                ...
                e.hasClass('is-empty') ||
                e.parent().hasClass('is-disabled') ? e.closest('.month-prev').length ? this.prevMonth() : e.closest('.month-next').length &&
                this.nextMonth() : (
                  this.setDate(
                    new Date(
      ...
      [
        ...
        },
        {
          ...
          value: function d(t) {
            ...
            o === this.dy &&
            this.setHand(s, o),
            'hours' === this.currentView ? this.showView('minutes', this.options.duration / 2) : this.options.autoClose &&
            (
        ...
        },
        {
          ...
          value: function u() {
            ...
            t ? this.$modalEl.appendTo(t) : this.$modalEl.insertBefore(this.el)
          }
        },
        {
          key: '_setupModal',
        ...
        },
        {
          ...
          value: function y() {
            for (var t = $('<div class="timepicker-tick"></div>'), e = 0; 60 > e; e += 5) {
              ...
              n.html(i._addLeadingZero(e)),
              this.minutesView.appendChild(n[0])
            }
          }
        },
        {
        ...
        },
        {
          ...
          value: function C(t, e) {
            'minutes' === t &&
            'visible' === $(this.hoursView).css('visibility');
            var i = 'hours' === t,
            ...
            $(n).css('visibility', 'visible').removeClass('timepicker-dial-out'),
            this.resetClock(e),
        ...
        },
        {
          ...
          value: function w(t) {
            ...
            a = n &&
            i > 0 &&
            13 > i ? this.options.innerRadius : this.options.outerRadius,
            r = Math.sin(o) * a,
            l = - Math.cos(o) * a,
            h = this;
            t ? (
              ...
              setTimeout(
                function () {
                  $(h.canvas).removeClass('timepicker-canvas-out'),
                  h.setHand(r, l)
                },
                t
              )
        ...
        },
        {
          ...
          value: function E(t, e, n) {
            ...
            o = u * r,
            this.options.twelveHour ? a ? 0 === u &&
            (u = 12) : (n && (u *= 5), 60 === u && (u = 0)) : a ? (12 === u && (u = 0), u = h ? 0 === u ? 12 : u : 0 === u ? 0 : u + 12) : (n && (u *= 5), 60 === u && (u = 0)),
            ...
            this[this.currentView] = u,
            a ? this.spanHours.innerHTML = u : this.spanMinutes.innerHTML = i._addLeadingZero(u);
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.el.M_CharacterCounter = n,
      n.options = $.extend({
      }, i.defaults, e),
      n.isInvalid = !1,
      n.isValidLength = !1,
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          ...
          value: function h() {
            this.isValidLength &&
            this.isInvalid ? (this.isInvalid = !1, this.$el.removeClass('invalid')) : this.isValidLength ||
            this.isInvalid ||
            (
              this.isInvalid = !0,
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.el.M_Carousel = n,
      n.options = $.extend({
      }, i.defaults, e),
      n.hasMultipleSlides = n.$el.find('.carousel-item').length > 1,
      n.showIndicators = n.options.indicators &&
      n.hasMultipleSlides,
      n.noWrap = n.options.noWrap ||
      !n.hasMultipleSlides,
      n.pressed = !1,
      n.dragged = !1,
      n.offset = n.target = 0,
      ...
      n.dim = 2 * n.itemWidth + n.options.padding ||
      1,
      ...
      n.$indicators = $('<ul class="indicators"></ul>'),
      n.$el.find('.carousel-item').each(
        function (t, e) {
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          ...
          value: function l(t) {
            return this.pressed ? (
              ...
              this.noWrap &&
              (
                this.target >= this.dim * (this.count - 1) ? this.target = this.dim * (this.count - 1) : this.target < 0 &&
                (this.target = 0)
              ),
        ...
        },
        {
          ...
          value: function v(t) {
            return t.targetTouches &&
            t.targetTouches.length >= 1 ? t.targetTouches[0].clientY : t.clientY
          }
        },
        {
          key: '_wrap',
        ...
        },
        {
          ...
          value: function y(t) {
            ...
            for (i = 1; n >= i; ++i) {
              if (
                this.options.fullWidth ? (h = this.options.dist, d = i === n && 0 > s ? 1 - a : 1) : (h = this.options.dist * (2 * i + a * o), d = 1 - p * (2 * i + a * o)),
                !this.noWrap ||
              ...
              if (
                this.options.fullWidth ? (h = this.options.dist, d = i === n && s > 0 ? 1 - a : 1) : (h = this.options.dist * (2 * i - a * o), d = 1 - p * (2 * i - a * o)),
                !this.noWrap ||
                this.center - i >= 0
              ) {
                r = this.images[this._wrap(this.center - i)];
        ...
        },
        {
          ...
          value: function b(t, e) {
            ...
            this.noWrap ||
            (
              0 > i ? Math.abs(i + this.count) < Math.abs(i) &&
              (i += this.count) : i > 0 &&
              Math.abs(i - this.count) < i &&
              (i -= this.count)
            ),
            this.target = this.dim * Math.round(this.offset / this.dim),
            0 > i ? this.target += this.dim * Math.abs(i) : i > 0 &&
  ...
  M.Carousel = e,
  M.jQueryLoaded &&
  M.initializeJqueryWrapper(e, 'carousel', 'M_Carousel')
}(cash),
function ($) {
  'use strict';
  var t = {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.el.M_TapTarget = n,
      n.options = $.extend({
      }, i.defaults, e),
      n.isOpen = !1,
      n.$origin = $('#' + n.$el.attr('data-target')),
      n._setup(),
      n._calculatePositioning(),
      n._setupEventHandlers(),
      n
    }
    return _inherits(i, e),
    _createClass(
      ...
      [
        ...
        },
        {
          key: '_handleDocumentClick',
          value: function h(t) {
            $(t.target).closest('.tap-target-wrapper').length ||
...
function ($) {
  ...
  e = function (e) {
    function i(t, e) {
      ...
      return n.$el.hasClass('browser-default') ? _possibleConstructorReturn(n) : (
        n.el.M_FormSelect = n,
        n.options = $.extend({
        }, i.defaults, e),
        n.isMultiple = n.$el.prop('multiple'),
        n.el.tabIndex = - 1,
        n._keysSelected = {},
        n._valueDict = {},
        n._setupDropdown(),
      ...
      [
        ...
        },
        {
          ...
          value: function s() {
            ...
            this._handleInputClickBound = this._handleInputClick.bind(this),
            $(this.dropdownOptions).find('li:not(.optgroup)').each(
              function (e) {
        ...
        },
        {
          ...
          value: function r(t) {
            ...
            if (
              ...
              } else $(this.dropdownOptions).find('li').removeClass('selected'),
              $(e).toggleClass('selected', n);
              $(this._valueDict[i].el).prop('selected', n),
              this.$el.trigger('change')
            }
            t.stopPropagation()
          }
          ...
          value: function h() {
            ...
            this.$selectOptions.each(
              function (e) {
                if ($(e).is('option')) {
                  var i = void 0;
                  i = t.isMultiple ? t._appendOptionWithIcon(t.$el, e, 'multiple') : t._appendOptionWithIcon(t.$el, e),
                  t._addOptionToValueDict(e, i)
                } else if ($(e).is('optgroup')) {
                  var n = $(e).children('option');
                  $(t.dropdownOptions).append(
                    $(
                      '<li class="optgroup"><span>' + e.getAttribute('label') + '</span></li>'
                    ) [0]
                  ),
                  n.each(
                    function (e) {
            ...
            if (this.$el.before(e[0]), !this.el.disabled) {
              ...
              i.onOpenEnd = function (e) {
                ...
                if (t.dropdown.isScrollable && i.length) {
                  ...
                  n -= t.dropdownOptions.clientHeight / 2,
                  t.dropdownOptions.scrollTop = n
                }
              },
              this.isMultiple &&
              (i.closeOnClick = !1),
        ...
        },
        {
          ...
          value: function c(t, e, i) {
            ...
            return $(this.dropdownOptions).append(a[0]),
            a[0]
          }
        },
        {
        ...
        },
        {
          ...
          value: function f() {
            ...
            for (var t in this._valueDict) {
              ...
              $(e.optionEl).find('input[type="checkbox"]').prop('checked', i),
              i ? (
                this._activateOption($(this.dropdownOptions), $(e.optionEl)),
                this._keysSelected[t] = !0
              ) : $(e.optionEl).removeClass('selected')
            }
          }
        },
        {
  ...
  custom: function (t) {
    ...
    if (
      ...
      (
        ...
        i.id = 'chartjs-tooltip',
        i.innerHTML = '<table></table>',
        document.body.appendChild(i)
      ),
      0 === t.opacity
    ) return void (i.style.opacity = 0);
    if (
      i.classList.remove('above', 'below', 'no-transform'),
      t.yAlign ? i.classList.add(t.yAlign) : i.classList.add('no-transform'),
      t.body
    ) {
      var n = t.title ||
      [],
    ...
    i.style.opacity = 1,
    i.style.left = $(window).scrollLeft() + l.left + t.caretX + 20 + 'px',
    i.style.top = $(window).scrollTop() + l.top + t.caretY + 'px',
    i.style.fontSize = t.fontSize,
    i.style.fontStyle = t._fontStyle,
    i.style.padding = t.yPadding + 'px ' + t.xPadding + 'px'
  }
},
areaOptions = {
...
flushChartOptions = Object.assign({
}, areaOptions);
...
var percentageFooterCallback = function (t, e) {
  ...
  t.forEach(
    function (t) {
      ...
      e.datasets[t.datasetIndex].data.forEach(function (t) {
        n += t
      })
    }
  );
...
doughnutLegendCallback = function (t) {
  ...
  if (t.data.datasets.length) for (var s = 0; s < t.data.datasets[0].data.length; s++) {
    ...
    r = $(
      '<li><span style="background-color: ' + a + '" class="dot"></span><span class="label">' + n[s] + '</span><span class="value">' + o + '</span></li>'
    );
    i.append(r)
  }
  return e.append(i),
...
percDoughnutLegendCallback = function (t) {
  if (
    ...
    for (
      ...
      n = '#000000',
      s = 0;
      s < t.data.datasets[0].data.length;
      s++
    ) {
      var o = t.data.datasets[0].data[s],
      a = t.data.datasets[0].backgroundColor[s];
...
cardLegendCallback = function (t) {
  for (
    var e = $('<div class="card-metrics"></div>'),
    i = 0;
    ...
    s = $(
      '<div class="card-metric colored waves-effect waves-light active"></div>'
    );
    n.borderColor &&
    s.css({
...
tabLegendCallback = function (t) {
  for (
    var e = $('<div class="card-tabs"></div>'),
    i = $('<ul class="tabs tabs-fixed-width tabs-transparent"></ul>'),
    n = 0;
...
!function ($) {
  $(document).ready(
    /* function () {
      ...
      Chart.defaults.bar.scales.xAxes[0].barPercentage = 0.85,
      ...
      Chart.defaults.radar.elements.point = {
        ...
        borderWidth: 0.0001,
        hoverRadius: 4,
        hoverBorderWidth: 0.0001
      },
      Chart.defaults.radar.elements.line.tension = 0.15,
      ...
      Chart.defaults.global.animation = Object.assign(
      ...
      $('#main-toggle-line-chart').closest('.card').find('.card-metrics').on(
        'click',
        '.card-metric',
        function (t) {
          t.stopPropagation();
          ...
          if (i.length) {
            ...
            if (s && n.hasOwnProperty(o)) {
              ...
              s.data.datasets[0].data = n[o].data,
              s.data.datasets[0].label = n[o].label,
              s.update()
            }
          }
        }
      ...
      O = $('#default-table-example').DataTable({
